...
What I did:
-Added validations in the event and comment controllers. validates for presence, uniqueness, and length
-Added the corresponding code in the new and edit views for both events and comments so that the right error messages are displayed whenever the validation critiera are not met
-Updated README file
-Stored code on my GitHub repository

Problems I encountered:
-Fixed problems pushing to heroku
